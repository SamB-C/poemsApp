const TheManhunt: string = `After the first phase,
...
const Sonnet43: string = `How do I love thee? Let me count the ways.
...
const London: string = `I wander thro' each charter'd street,
...
And blights with plagues the Marrige hearse.`;

const TheSoldier: string = `If I should die, think only this of me:
...
const SheWalksInBeauty: string = `She walks in beauty, like the night
...
const LivingSpace: string = `There are just not enough
straight lines. That
is the problem.
Nothing is flat
of parallel. Beams
...
const AsImperceptiblyAsGrief: string = `As imperceptibly as Grief
The Summer lapsed away -
Too impoerceptible at last
...
A courteous, yeet harrowing Grace,
And thus, without a Wing
Or service of a Keel
Our Summer made her light escape
Into the Beautiful`;

const CozyApologia: string = `                  -for Fred
...
Oddly male: Big Bad Floyd, who bring a host of
...
Were thin a licorice and as chewy,
...
const AWifeInLondon: string = `I - The Tradegy
...
const DeathOfANaturalist: string = `All year round the flax-dam festered in the heart
...
On sheleves at school, and wait and watch until
...
Before. The air was thich with a bass chorus.
Right down the dam gross-bellied frogs were cocked
On sods; their loose necks pulsed like sails. Some hopped:
The slap and plop were obscene threats. Some sat
Poised like mud grenades, their blunt heads farting.
I sickened, turned and ran. The great slime kings
Were gathered there for vengance and I knew
That if I dipped my hand the spawn would clutch it.`;

const HawkRoosting: string = `I sit in the top of the wood, my eyes closed.
Inaction, no falsifying dream
Between my hooked head and hooked feet:
Or in sleep rehearse perfect kills and eat.

The convinence of the high trees!
...
To produce my each foot, my each feather:
...
const ToAutumn: string = `Seasons of mist and mellow fruitfulness!
...
Until they think worm days will never cease,
    For Summer has o'erbrimmed their clammy cells.
    
Who hath not seen thee oft amid thy store?
  Sometimes whoever seeks abroad may find
Thee sitting careless on a granary floor,
  Thy hair soft-linted by winnowing wind;
...
And full-grown lambs loud bleat from hilly bourn;
  ...
  The red-brest whistles from a garden-croft;
    And gathering swollows twitter in the skies.`;

const Afternoons: string = `Summer is fading:
...
const DulceetDecorumEst: string = `Bent double, like old beggars under sacks,
Knock-kneed, coughing like hags, we cursed through sludge,
Till on the hauting flares we turned our backs
And towards our distant rest began to trudge.
Men marched asleep. Many had lost their boots
But limped on, blood-shod. All went lame; all blind;
Drunkn with fatigue; deaf even to the hoots
...
const Ozymandias: string = `I met a traveller from an antique land
...
const MametzWood: string = `For years afterwards the farmers found them -
...
const ExcerptfromThePrelude: string = `    And in the frosty season, when the sun
Was set, and visible for many a mile
The cottage windows through the twilight blaz'd,
I heeded not the summons: - happy time
It was, indeed, for all of us: to me
It was a time rapture: clear and loud
The village clock tolled six: I wheel'd about,
Pround and exulting, like an untir'ed horse,
...
export const poems = {
    'The Manhunt': TheManhunt,
    'Sonnet43': Sonnet43,
    'London': London,
    'The Soldier': TheSoldier,
    'She Walks in Beauty': SheWalksInBeauty,
    'Living Space': LivingSpace,
    'As Imperceptibly as Grief': AsImperceptiblyAsGrief,
    'Cozy Apologia': CozyApologia,
    'Valentine': Valentine,
    'A Wife in London': AWifeInLondon,
    'Death of a Naturalist': DeathOfANaturalist,
    'Hawk Roosting': HawkRoosting,
    'To Autumn': ToAutumn,
    'Afternoons': Afternoons,
    'Dulce et Decorum Est': DulceetDecorumEst,
    'Ozymandias': Ozymandias,
    'Mametz Wood': MametzWood,
    'Excerpt from The Prelude': ExcerptfromThePrelude
}
